with planejada as (
select * 
from `rj-smtr-dev.projeto_multa_automatica.frota_planejada` 
),
realizada as (
select * 
from `rj-smtr-dev.projeto_multa_automatica.frota_realizada`
),
merged as (
...
on realizada.data = planejada.data and realizada.linha = planejada.linha 
)
SELECT data, linha, pico, frota_realizada, frota_planejada, porcentagem_operacao,
        CASE
