...
CREATE VIEW rj-smtr-dev.br_rj_riodejaneiro_gtfs_planned.realized_trips_planned AS
SELECT 
...
from rj-smtr-dev.br_rj_riodejaneiro_gtfs_planned_staging.realized_trips_planned as t