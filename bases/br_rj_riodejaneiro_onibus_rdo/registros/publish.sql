...
CREATE VIEW rj-smtr.br_rj_riodejaneiro_onibus_rdo.registros AS
SELECT 
...
SAFE_CAST(gratuidade_estudande_federal AS INT64) gratuidade_estudande_federal,
SAFE_CAST(gratuidade_estudande_estadual AS INT64) gratuidade_estudande_estadual,
...
SAFE_CAST(REPLACE(total_passageiro_transportado, '.', '') AS INT64) total_passageiro_transportado,
...
from rj-smtr-staging.br_rj_riodejaneiro_onibus_rdo_staging.registros as t